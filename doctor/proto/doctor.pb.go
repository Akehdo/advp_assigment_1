...
const file_doctor_proto_doctor_proto_rawDesc = "" +
	"\n" +
	"\x19doctor/proto/doctor.proto\x12\x06doctor\"p\n" +
	...
	"\vListDoctors\x12\x1a.doctor.ListDoctorsRequest\x1a\x1b.doctor.ListDoctorsResponseB4Z2github.com/Akendo/assigment1/doctor/proto;doctorpbb\x06proto3"

var (
	file_doctor_proto_doctor_proto_rawDescOnce sync.Once
	file_doctor_proto_doctor_proto_rawDescData []byte
)

func file_doctor_proto_doctor_proto_rawDescGZIP() []byte {
	file_doctor_proto_doctor_proto_rawDescOnce.Do(func() {
		file_doctor_proto_doctor_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doctor_proto_doctor_proto_rawDesc), len(file_doctor_proto_doctor_proto_rawDesc)))
	})
	return file_doctor_proto_doctor_proto_rawDescData
}

var file_doctor_proto_doctor_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_doctor_proto_doctor_proto_goTypes = []any{
...
func file_doctor_proto_doctor_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doctor_proto_doctor_proto_rawDesc), len(file_doctor_proto_doctor_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
